...
<section class="about section" id="about">
            <h3 class="section__subtitle">Our Story <span>& Motive</span>
            </h3>
            ...
            <div class="about__container container grid">
               ...
               <div class="about__image">
                  <svg class="about__blob" viewBox="0 0 550 592" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <defs>
                         ...
                         <image class="about__img" id="imageBorder" width="640" height="940" href="<?php echo BASE_URL . 'assets/media/icons/logo.jpg' ?>"/>
                      </defs>
                   </svg>
              </div>
               ...
               <div class="about__data">
                   ...
                   <p class="about__description desc">
                     No 1 supplier of Proprietary Agro-Chemicals, Seed and Sprayer equipment in Malawi.
                   </p>
                   <p class="about__description">
                     <span>Our Locations</span><br><br><br>
                     <span>South Territory</span> - Plot NW119, Makata Road, Blantyre <br><br>
                     <span>North & South Territory</span> - Plot 29/120 Auction Road, Kanengo, Lilongwe <br><br>
                     <span>North Territory</span> - Vikanu Building, Kamuzu Road, Mzuzu
                   </p>
